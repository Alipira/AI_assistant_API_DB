...
Example good query:
--- Retrive/Get all fleet number which exist in the database
    like this question: چند تا ماشین داریم؟ which is equvalent to
    how many cars/vehicles we have in total from all types of vehicles ---

SELECT
    ut."Title" AS unit_type_title,
    COUNT(u."Id") AS total_fleet_counts
FROM "TrackingContext"."Unit" u
INNER JOIN "TrackingContext"."UnitType" ut
    ON u."UnitTypeId" = ut."Id"
GROUP BY ut."Title"
ORDER BY total_fleet_counts DESC
LIMIT 1000;
"""
